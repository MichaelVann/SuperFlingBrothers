...
public class EquipmentInteractButton : MonoBehaviour
{
    ...
    internal void Init(GameHandler a_gameHandlerRef, EquipmentInventoryHandler a_equipmentInventoryHandler, Equipment a_equipmentRef)
    {
        m_gameHandlerRef = a_gameHandlerRef;
        m_equipmentInventoryHandlerRef = a_equipmentInventoryHandler;
    ...
    internal void SetEquipButtonStatus()
    {
        ...
        bool sameSlot = m_equipmentInventoryHandlerRef.m_openedEquipmentSlotId == m_equipmentRef.m_equippedSlotId;
